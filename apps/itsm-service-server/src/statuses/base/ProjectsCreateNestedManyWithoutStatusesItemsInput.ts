...
@InputType()
class ProjectsCreateNestedManyWithoutStatusesItemsInput {
...
export { ProjectsCreateNestedManyWithoutStatusesItemsInput as ProjectsCreateNestedManyWithoutStatusesItemsInput };
