...
@InputType()
class ProjectsCreateNestedManyWithoutRequestsItemsInput {
...
export { ProjectsCreateNestedManyWithoutRequestsItemsInput as ProjectsCreateNestedManyWithoutRequestsItemsInput };
