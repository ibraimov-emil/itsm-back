...
@InputType()
class ProjectsCreateNestedManyWithoutClientsItemsInput {
...
export { ProjectsCreateNestedManyWithoutClientsItemsInput as ProjectsCreateNestedManyWithoutClientsItemsInput };
