...
@InputType()
class ProjectsCreateNestedManyWithoutServicesItemsInput {
...
export { ProjectsCreateNestedManyWithoutServicesItemsInput as ProjectsCreateNestedManyWithoutServicesItemsInput };
